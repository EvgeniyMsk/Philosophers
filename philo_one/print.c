...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/03 14:13:07 by qsymond           #+#    #+#             */
/*   Updated: 2020/11/03 14:13:08 by qsymond          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				print_error(int error)
{
	if (error == WRONG_ARG)
		...
		write(2, "Error: mutex error\n",
		ft_strlen("Error: mutex error\n"));
	else if (error == PTHREAD)
		write(2, "Error: pthread error\n",
		ft_strlen("Error: pthread error\n"));
	else if (error == SLEEP)
